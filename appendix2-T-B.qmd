...
process_line <- function(line) {
  ...
  if (xml_name(line) == "l") {
    ...
    if (line_count == 895) {
      return("<div style='line-height: 1.2;'><span class='line-number'>895</span>Dame Zosimas lirespot .</div>")
    }
...
process_line <- function(line) {
  ...
  if (xml_name(line) == "l") {
    ...
    if (line_count == 5) {
      return("<div style='line-height: 1.2;'><span class='line-number'>5</span>bien croi que volentiers lorunt .</div>")
    }
    
    # SPECIAL CASE: Hard-code line v.15 to correct apostrophe
    if (line_count == 15) {
      return("<div style='line-height: 1.2;'><span class='line-number'>15</span>Que nuz pechiez nen est tant granz.</div>")
    }
    
    # SPECIAL CASE: Hard-code line v.22 to correct accent
    if (line_count == 22) {
      return("<div style='line-height: 1.2;'>cil pechiez niet ja pardone</div>")
    }
    ...
    # SPECIAL CASE: Hard-code line v.45 to correct accent
    if (line_count == 45) {
      return("<div style='line-height: 1.2;'><span class='line-number'>45</span>gerpit la male iniquite .</div>")
    }
    ...
    if (line_count == 85) {
      return("<div style='line-height: 1.2;'><span class='line-number'>85</span>Filhe tues degrant parage .</div>")
    }
    ...
    if (line_count == 100) {
      return("<div style='line-height: 1.2;'><span class='line-number'>100</span>si konques puis nuz nela vit</div>")
    }
    ...
    if (line_count == 115) {
      return("<div style='line-height: 1.2;'><span class='line-number'>115</span>Mais porfaire lesien delit.</div>")
    }
    
    # SPECIAL CASE: Hard-code line v.122 to correct accent
    if (line_count == 122) {
      return("<div style='line-height: 1.2;'>o les garcons aloit jower</div>")
    }
    ...
    if (line_count == 130) {
      return("<div style='line-height: 1.2;'><span class='line-number'>130</span>sentredonoient grant colees</div>")
    }
    ...
    if (line_count == 140) {
      return("<div style='line-height: 1.2;'><span class='line-number'>140</span>parli nefusent visitet</div>")
    }
    ...
    if (line_count == 180) {
      return("<div style='line-height: 1.2;'><span class='line-number'>180</span>Jasefacons neniert descrite</div>")
    }
    ...
    if (line_count == 200) {
      return("<div style='line-height: 1.2;'><span class='line-number'>200</span>mut fait aplendre sajovente</div>")
    }
    ...
    if (line_count == 210) {
      return("<div style='line-height: 1.2;'><span class='line-number'>210</span>u soloit faire sendeport</div>")
    }
    
    # SPECIAL CASE: Hard-code line v.215 to correct spacing
    if (line_count == 215) {
      return("<div style='line-height: 1.2;'><span class='line-number'>215</span>enJherusalem en aloient.</div>")
    }
    ...
    if (line_count == 220) {
      return("<div style='line-height: 1.2;'><span class='line-number'>220</span>sensalhoient fors el gravier</div>")
    }
    ...
    # SPECIAL CASE: Hard-code line v.225 to correct accent
    if (line_count == 225) {
      return("<div style='line-height: 1.2;'><span class='line-number'>225</span>apres li vit unhome ester.</div>")
    }
    
    # SPECIAL CASE: Hard-code line v.230 to correct spacing
    if (line_count == 230) {
      return("<div style='line-height: 1.2;'><span class='line-number'>230</span>qui laissent decel dromon</div>")
    }
    ...
    if (line_count == 275) {
      return("<div style='line-height: 1.2;'><span class='line-number'>275</span>simenvoroie ovos aler.</div>")
    }
    ...
    if (line_count == 280) {
      return("<div style='line-height: 1.2;'><span class='line-number'>280</span>puis sisefirent desaancrer</div>")
    }
    ...
    # SPECIAL CASE: Hard-code line v.288 to correct accent
    if (line_count == 288) {
      return("<div style='line-height: 1.2;'>& enapres aacoleir</div>")
    }
    
    # SPECIAL CASE: Hard-code line v.289 to correct accent
    if (line_count == 289) {
      return("<div style='line-height: 1.2;'>apres lacoler le baisier.</div>")
    }
    ...
    # SPECIAL CASE: Hard-code line v.308 to correct accent
    if (line_count == 308) {
      return("<div style='line-height: 1.2;'>ille recovient abongreiz</div>")
    }
    ...
    # SPECIAL CASE: Hard-code line v.328 to correct accent
    if (line_count == 328) {
      return("<div style='line-height: 1.2;'>ain comenca aenpirier</div>")
    }
    ...
    if (line_count == 345) {
      return("<div style='line-height: 1.2;'><span class='line-number'>345</span>Lipelerin quileveoient .</div>")
    }
    ...
    if (line_count == 360) {
      return("<div style='line-height: 1.2;'><span class='line-number'>360</span>selidefendoient lentree</div>")
    }
    ...
    if (line_count == 370) {
      return("<div style='line-height: 1.2;'><span class='line-number'>370</span>grans coz sedone alapoitrine</div>")
    }
    ...
    if (line_count == 380) {
      return("<div style='line-height: 1.2;'><span class='line-number'>380</span>demalvastiet & deluxure</div>")
    }
    ...
    if (line_count == 385) {
      return("<div style='line-height: 1.2;'><span class='line-number'>385</span>Regarde verdestrepartie .</div>")
    }
    
    # SPECIAL CASE: Hard-code line v.390 to correct spacing
    if (line_count == 390) {
      return("<div style='line-height: 1.2;'><span class='line-number'>390</span>qui enten cors portas ten pere</div>")
    }
    ...
    if (line_count == 400) {
      return("<div style='line-height: 1.2;'><span class='line-number'>400</span>nequier altre medecinals</div>")
    }
    ...
    if (line_count == 415) {
      return("<div style='line-height: 1.2;'><span class='line-number'>415</span>& enmencuer ai me creance .</div>")
    }
    
    # SPECIAL CASE: Hard-code line v.417 to correct accent
    if (line_count == 417) {
      return("<div style='line-height: 1.2;'>Il mist entoi humanite .</div>")
    }
    ...
    if (line_count == 445) {
      return("<div style='line-height: 1.2;'><span class='line-number'>445</span>com il fist lepremier ome.</div>")
    }
    
    # SPECIAL CASE: Hard-code line v.450 to correct spacing
    if (line_count == 450) {
      return("<div style='line-height: 1.2;'><span class='line-number'>450</span>partraison li donat mort</div>")
    }
    ...
    if (line_count == 470) {
      return("<div style='line-height: 1.2;'><span class='line-number'>470</span>enciel monta puis asenPere</div>")
    }
    ...
    if (line_count == 475) {
      return("<div style='line-height: 1.2;'><span class='line-number'>475</span>orsiet ala destre senPere .</div>")
    }
    ...
    if (line_count == 485) {
      return("<div style='line-height: 1.2;'><span class='line-number'>485</span>Qui celui portas enten ventre .</div>")
    }
    ...
    if (line_count == 505) {
      return("<div style='line-height: 1.2;'><span class='line-number'>505</span>vint une voizqueeleentent .</div>")
    }
    ...
    if (line_count == 570) {
      return("<div style='line-height: 1.2;'><span class='line-number'>570</span>quele devint tote salvage</div>")
    }
    ...
    if (line_count == 590) {
      return("<div style='line-height: 1.2;'><span class='line-number'>590</span>&deblanc poilh tote mossue</div>")
    }
    ...
    if (line_count == 605) {
      return("<div style='line-height: 1.2;'><span class='line-number'>605</span>Nefat aplaindreli pechiez.</div>")
    }
    
    # SPECIAL CASE: Hard-code line v.610 to correct spacing
    if (line_count == 610) {
      return("<div style='line-height: 1.2;'><span class='line-number'>610</span>deces viscat par plusorsanz</div>")
    }
    ...
    if (line_count == 635) {
      return("<div style='line-height: 1.2;'><span class='line-number'>635</span>Marie vat parleboscage .</div>")
    }
    ...
    if (line_count == 660) {
      return("<div style='line-height: 1.2;'><span class='line-number'>660</span>ce ert depain & depulment</div>")
    }
    ...
    if (line_count == 665) {
      return("<div style='line-height: 1.2;'><span class='line-number'>665</span>Navoient soig dargent nedor .</div>")
    }
    ...
    if (line_count == 670) {
      return("<div style='line-height: 1.2;'><span class='line-number'>670</span>alpremier jor faisoient caine.</div>")
    }
    ...
    # SPECIAL CASE: Hard-code line v.726 to correct accent
    if (line_count == 726) {
      return("<div style='line-height: 1.2;'>apres faissoit les vis fermer</div>")
    }
    ...
    if (line_count == 740) {
      return("<div style='line-height: 1.2;'><span class='line-number'>740</span>mut ert vestuz depovredras</div>")
    }
    
    # SPECIAL CASE: Hard-code line v.751 to correct accent
    if (line_count == 751) {
      return("<div style='line-height: 1.2;'>endroit midi comencat sore .</div>")
    }
    ...
    if (line_count == 785) {
      return("<div style='line-height: 1.2;'><span class='line-number'>785</span>Lisains hom levat encacant .</div>")
    }
    ...
    # SPECIAL CASE: Hard-code line v.810 to correct accent
    if (line_count == 810) {
      return("<div style='line-height: 1.2;'><span class='line-number'>810</span>apres poras parler amoi</div>")
    }
    ...
    if (line_count == 820) {
      return("<div style='line-height: 1.2;'><span class='line-number'>820</span>ver leprodome est tornee</div>")
    }
    ...
    if (line_count == 835) {
      return("<div style='line-height: 1.2;'><span class='line-number'>835</span>Mercilicrie mut sovent .</div>")
    }
    
    # SPECIAL CASE: Hard-code line v.840 to correct apostrophe
    if (line_count == 840) {
      return("<div style='line-height: 1.2;'><span class='line-number'>840</span>parlebarbe quest chenue</div>")
    }
    ...
    if (line_count == 850) {
      return("<div style='line-height: 1.2;'><span class='line-number'>850</span>porce siest plus covenant</div>")
    }
    ...
    if (line_count == 860) {
      return("<div style='line-height: 1.2;'><span class='line-number'>860</span>& li vins sans quenissit fors</div>")
    }
    
    # SPECIAL CASE: Hard-code line v.875 to correct spacing
    if (line_count == 875) {
      return("<div style='line-height: 1.2;'><span class='line-number'>875</span>totens iert en sabenetele orison.</div>")
    }
    ...
    # SPECIAL CASE: Hard-code line v.895 to correct spacing
    if (line_count == 895) {
      return("<div style='line-height: 1.2;'><span class='line-number'>895</span>Dame Zosimas lirespont .</div>")
    }
    ...
    if (line_count == 910) {
      return("<div style='line-height: 1.2;'><span class='line-number'>910</span>Mais nule vois fors nen issoit</div>")
    }
    ...
    # SPECIAL CASE: Hard-code line v.926 to correct accent
    if (line_count == 926) {
      return("<div style='line-height: 1.2;'>sel comencat arapeller</div>")
    }
    ...
    if (line_count == 950) {
      return("<div style='line-height: 1.2;'><span class='line-number'>950</span>riens necelat quetot ne die</div>")
    }
    ...
    if (line_count == 970) {
      return("<div style='line-height: 1.2;'><span class='line-number'>970</span>porDeu aies demoi merci</div>")
    }
    
    # SPECIAL CASE: Hard-code line v.985 to correct spacing
    if (line_count == 985) {
      return("<div style='line-height: 1.2;'><span class='line-number'>985</span>entenlit te storat gesir.</div>")
    }
    ...
    if (line_count == 995) {
      return("<div style='line-height: 1.2;'><span class='line-number'>995</span>desen sanc en altre vaissel.</div>")
    }
    ...
    if (line_count == 1010) {
      return("<div style='line-height: 1.2;'><span class='line-number'>1010</span>elgrant desert en est entree</div>")
    }
    ...
    if (line_count == 1015) {
      return("<div style='line-height: 1.2;'><span class='line-number'>1015</span>Aterresest engenolhiez.</div>")
    }
    
    # SPECIAL CASE: Hard-code line v.1020 to correct spacing
    if (line_count == 1020) {
      return("<div style='line-height: 1.2;'><span class='line-number'>1020</span>ki enfemme as mis tel vertu</div>")
    }
    ...
    # SPECIAL CASE: Hard-code line v.1024 to correct accent
    if (line_count == 1024) {
      return("<div style='line-height: 1.2;'>si quemenca arepairier</div>")
    }
    
    # SPECIAL CASE: Hard-code line v.1030 to correct apostrophe
    if (line_count == 1030) {
      return("<div style='line-height: 1.2;'><span class='line-number'>1030</span>dece quil orent veu</div>")
    }
    ...
    if (line_count == 1035) {
      return("<div style='line-height: 1.2;'><span class='line-number'>1035</span>ensenlit gist Zozimas.</div>")
    }
    ...
    if (line_count == 1055) {
      return("<div style='line-height: 1.2;'><span class='line-number'>1055</span>crient dela rien keplus convoite.</div>")
    }
    ...
    if (line_count == 1060) {
      return("<div style='line-height: 1.2;'><span class='line-number'>1060</span>& porce sen soit repairie</div>")
    }
    ...
    if (line_count == 1065) {
      return("<div style='line-height: 1.2;'><span class='line-number'>1065</span>Janenvivrai siqum jespoir .</div>")
    }
    ...
    if (line_count == 1080) {
      return("<div style='line-height: 1.2;'><span class='line-number'>1080</span>bele merecoment leferas</div>")
    }
    ...
    if (line_count == 1090) {
      return("<div style='line-height: 1.2;'><span class='line-number'>1090</span>mut senmervelhe Zozimas</div>")
    }
    ...
    if (line_count == 1110) {
      return("<div style='line-height: 1.2;'><span class='line-number'>1110</span>quil la li die porDeu</div>")
    }
    ...
    # SPECIAL CASE: Hard-code line v.1113 to correct spacing
    if (line_count == 1113) {
      return("<div style='line-height: 1.2;'>La dame respont apres lui.</div>")
    }
    ...
    if (line_count == 1115) {
      return("<div style='line-height: 1.2;'><span class='line-number'>1115</span>cant orent fait lorparlement .</div>")
    }
    ...
    if (line_count == 1135) {
      return("<div style='line-height: 1.2;'><span class='line-number'>1135</span>Lisains lot siderainier .</div>")
    }
    
    # SPECIAL CASE: Hard-code line v.1140 to correct spacing
    if (line_count == 1140) {
      return("<div style='line-height: 1.2;'><span class='line-number'>1140</span>Lecors manjat . & lesanc buit</div>")
    }
    ...
    if (line_count == 1145) {
      return("<div style='line-height: 1.2;'><span class='line-number'>1145</span>Biaz Sireoroies morison .</div>")
    }
    ...
    if (line_count == 1200) {
      return("<div style='line-height: 1.2;'><span class='line-number'>1200</span>fors dun drapel tot derompuz</div>")
    }
    ...
    if (line_count == 1215) {
      return("<div style='line-height: 1.2;'><span class='line-number'>1215</span>tant laquise par ledesert .</div>")
    }
    ...
    if (line_count == 1220) {
      return("<div style='line-height: 1.2;'><span class='line-number'>1220</span>unes letres vit en unbrief</div>")
    }
    ...
    if (line_count == 1240) {
      return("<div style='line-height: 1.2;'><span class='line-number'>1240</span>& senipot nule rien faire</div>")
    }
    ...
    if (line_count == 1265) {
      return("<div style='line-height: 1.2;'><span class='line-number'>1265</span>& lileons apiez latprise .</div>")
    }
    ...
    if (line_count == 1280) {
      return("<div style='line-height: 1.2;'><span class='line-number'>1280</span>signefist deprendre congiez</div>")
    }
    ...
    if (line_count == 1315) {
      return("<div style='line-height: 1.2;'><span class='line-number'>1315</span>Niot un namendast savie .</div>")
    }
    ...
    if (line_count == 1320) {
      return("<div style='line-height: 1.2;'><span class='line-number'>1320</span>decuiavons oit lavie</div>")
    }
...
process_line <- function(line) {
  ...
  if (xml_name(line) == "l") {
    ...
    if (line_count == 470) {
      return("<div style='line-height: 1.2;'><span class='line-number'>470</span>en ciel monta puis a sen Pere</div>")
    }
    
    # SPECIAL CASE: Hard-code line v.475 to correct double "Pere"
    if (line_count == 475) {
      return("<div style='line-height: 1.2;'><span class='line-number'>475</span>or siet a la destre sen Pere.</div>")
    }
    ...
    if (line_count == 680) {
      return("<div style='line-height: 1.2;'><span class='line-number'>680</span>a Damledeu les comandoit</div>")
    }
    ...
    if (line_count == 690) {
      return("<div style='line-height: 1.2;'><span class='line-number'>690</span>de Deu vivoient li plusor</div>")
    }
    ...
    if (line_count == 770) {
      return("<div style='line-height: 1.2;'><span class='line-number'>770</span>La figure vit de Marie</div>")
    }
    ...
    if (line_count == 793) {
      return("<div style='line-height: 1.2;'>Je te conjur par Dé le grant.</div>")
    }
    
    # SPECIAL CASE: Hard-code line v.795 to correct double "Deu"
    if (line_count == 795) {
      return("<div style='line-height: 1.2;'><span class='line-number'>795</span>cant la dame ot de Deu parler .</div>")
    }
    
    # SPECIAL CASE: Hard-code line v.840 to correct spacing
    if (line_count == 840) {
      return("<div style='line-height: 1.2;'><span class='line-number'>840</span>par le barbe qu’est chenue</div>")
    }
    
    # SPECIAL CASE: Hard-code line v.895 to correct spacing
    if (line_count == 895) {
      return("<div style='line-height: 1.2;'><span class='line-number'>895</span>Dame Zosimas li respont .</div>")
    }
    
    # SPECIAL CASE: Hard-code line v.907 to correct double "prie"
    if (line_count == 907) {
      return("<div style='line-height: 1.2;'>& Dé prie le Creator.</div>")
    }
    ...
    # SPECIAL CASE: Hard-code line v.963 to correct repetition
    if (line_count == 963) {
      return("<div style='line-height: 1.2;'>Dame por coi kiés a mes piez.</div>")
    }
    ...
    if (line_count == 970) {
      return("<div style='line-height: 1.2;'><span class='line-number'>970</span>por Deu aies de moi merci</div>")
    }
    
    # SPECIAL CASE: Hard-code line v.1110 to correct double "Deu"
    if (line_count == 1110) {
      return("<div style='line-height: 1.2;'><span class='line-number'>1110</span>qu’il la li die por Deu</div>")
    }
    ...
    if (line_count == 1230) {
      return("<div style='line-height: 1.2;'><span class='line-number'>1230</span>sel sevelis a Deu aie</div>")
    }
