...
process_line <- function(line) {
  ...
  if (xml_name(line) == "l") {
    ...
    if (line_count == 1) {
      return("<div style='line-height: 1.2;'>Seignurs pur lamur JhesuCrist</div>")
    }
    ...
    if (line_count == 1295) {
      return("<div style='line-height: 1.2;'>ke meuz oleit eplusforment</div>")
    }
    ...
    if (line_count == 1465) {
      return("<div style='line-height: 1.2;'>Dekanque il sout obeir</div>")
    }
