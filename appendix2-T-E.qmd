...
process_line <- function(line) {
  ...
  if (xml_name(line) == "l") {
    ...
    if (line_count == 80) {
      return("<div style='line-height: 1.2;'>Car croi le conseil detonpere</div>")
    }
    ...
    if (line_count == 185) {
      return("<div style='line-height: 1.2;'>Netrop grande netrop petite</div>")
    }
    ...
    if (line_count == 190) {
      return("<div style='line-height: 1.2;'>Rien ni avoit queamender</div>")
    }
    ...
    if (line_count == 245) {
      return("<div style='line-height: 1.2;'>dont li respondi li preu dom</div>")
    }
    ...
    if (line_count == 305) {
      return("<div style='line-height: 1.2;'>Quien peust prendre respit</div>")
    }
    ...
    if (line_count == 323) {
      return("<div style='line-height: 1.2;'>Merveille fu cevoirement</div>")
    }
    ...
    if (line_count == 450) {
      return("<div style='line-height: 1.2;'>Quant de safille fist samere</div>")
    }
    ...
    if (line_count == 600) {
      return("<div style='line-height: 1.2;'>Ains se lairoit defaim morir</div>")
    }
    ...
    if (line_count == 635) {
      return("<div style='line-height: 1.2;'>itant avoit noir lementon</div>")
    }
    
    # SPECIAL CASE: Hard-code line v.640 to correct spacing
    if (line_count == 640) {
      return("<div style='line-height: 1.2;'>molt vos venist agrant merveille</div>")
    }
    ...
    if (line_count == 720) {
      return("<div style='line-height: 1.2;'>fors seul al eure demanger</div>")
    }
    ...
    if (line_count == 810) {
      return("<div style='line-height: 1.2;'>molt ert vestus depovresdras</div>")
    }
    ...
    if (line_count == 890) {
      return("<div style='line-height: 1.2;'>de mon noir cors quesiest lasques</div>")
    }
    ...
    if (line_count == 980) {
      return("<div style='line-height: 1.2;'>Qui loie mais parler degerre</div>")
    }
    ...
    if (line_count == 1010) {
      return("<div style='line-height: 1.2;'>Saches quejo sui crestiene</div>")
    }
    
    # SPECIAL CASE: Hard-code line v.1020 to correct spacing
    if (line_count == 1020) {
      return("<div style='line-height: 1.2;'>apres commenca aparler</div>")
    }
    ...
    if (line_count == 1025) {
      return("<div style='line-height: 1.2;'>dilemoi par con fession</div>")
    }
    
    # SPECIAL CASE: Hard-code line v.1033 to correct spacing
    if (line_count == 1033) {
      return("<div style='line-height: 1.2;'>Dont commence aconter Marie</div>")
    }
    ...
    if (line_count == 1095) {
      return("<div style='line-height: 1.2;'>desque passai leflun Jordan</div>")
    }
    ...
    if (line_count == 1115) {
      return("<div style='line-height: 1.2;'>puis li menbra de sonmoster</div>")
    }
    ...
    if (line_count == 1335) {
      return("<div style='line-height: 1.2;'>Sigrant miracle Dex ifist</div>")
    }
    ...
    # SPECIAL CASE: Hard-code line v.1339 to correct spacing
    if (line_count == 1339) {
    ...
    if (line_count == 1355) {
      return("<div style='line-height: 1.2;'>tant laquist il par le desert</div>")
    }
    ...
    if (line_count == 1365) {
      return("<div style='line-height: 1.2;'>des que jo voie cele feme</div>")
    }
    ...
    if (line_count == 1390) {
      return("<div style='line-height: 1.2;'>poi sen faloit queniert totnu</div>")
    }
    ...
    if (line_count == 1465) {
      return("<div style='line-height: 1.2;'>li lions fuet laterre dure</div>")
    }
    ...
    if (line_count == 1485) {
      return("<div style='line-height: 1.2;'>tote laterre rasamble</div>")
    }
    ...
    if (line_count == 1490) {
      return("<div style='line-height: 1.2;'>Samblant fait deprandre congiet</div>")
    }
    ...
    if (line_count == 1520) {
      return("<div style='line-height: 1.2;'>de leve quetant ert parfonde</div>")
    }
...
process_line <- function(line) {
  ...
  if (xml_name(line) == "l") {
    ...
    if (line_count == 80) {
      return("<div style='line-height: 1.2;'>Car croi le conseil de ton pere</div>")
    }
