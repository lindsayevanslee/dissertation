...
process_line <- function(line) {
  ...
  if (xml_name(line) == "l") {
    ...
    if (line_count == 10) {
      return("<div style='line-height: 1.2;'>e por sa amor mei escoter .</div>")
    }
    
    # SPECIAL CASE: Hard-code line v.15 to correct spacing
    if (line_count == 15) {
      return("<div style='line-height: 1.2;'>Quenul pecche est tant granz .</div>")
    }
    ...
    if (line_count == 115) {
      return("<div style='line-height: 1.2;'>Tuit enveneient al bordal .</div>")
    }
