...
process_line <- function(line) {
  ...
  if (xml_name(line) == "l") {
    ...
    if (line_count == 65) {
      return("<div style='line-height: 1.2;'>Por ceo quele estoit bele . & gente</div>")
    }
    ...
    if (line_count == 350) {
      return("<div style='line-height: 1.2;'>Miex fust quil i corust feu</div>")
    }
    ...
    if (line_count == 750) {
      return("<div style='line-height: 1.2;'>Quil cremoient de lor maisun</div>")
    }
